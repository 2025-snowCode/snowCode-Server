...
public record CourseCountWithAssignmentResponse(
        ...
        List<AssignmentSimpleResponse> courses) {

        public static CourseCountWithAssignmentResponse of(Course course, List<AssignmentSimpleResponse> assignments) {
                return new CourseCountWithAssignmentResponse(course.getId(), course.getTitle(), course.getYear(), course.getSemester().toString(), course.getSection(), assignments.size(), assignments);
        }
}
